...
export function CardGroupFilterBar({
  ...
  return (
    <nav className="rule-top rule-bottom mt-6 flex flex-wrap items-center gap-x-4 gap-y-2 font-body text-[12px] py-3">
      ...
      <button
        ...
        className="ml-auto font-body text-[11px] uppercase tracking-[0.14em] text-[color:var(--color-ink-muted)] transition-colors hover:text-[color:var(--color-accent)]"
      >
        gerenciar
      </button>
    </nav>
